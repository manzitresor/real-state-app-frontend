...
export default function HeroSection() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-12 h-screen bg-soft-gray relative">
      <div className="md:col-span-6 py-10 px-4 md:px-20 space-y-4 flex flex-col justify-between">
      ...
      <ul className="h-16 w-80 bg-green-primary-200 absolute left-2 md:left-20 bottom-72 rounded-t-lg border-b-2 flex gap-x-12 font-bold text-lg items-center text-black px-4">
        <li>Rent</li>
        <li>Buy</li>
        <li>Sell</li>
      </ul>
      <div className="h-20 w-[44rem] bg-green-primary-200 absolute left-2 md:left-20 bottom-52 flex gap-x-5 px-4 items-center justify-between">
        <div>
